...
exports.BrainMCPServerV2 = void 0;
const mcp_js_1 = require("@modelcontextprotocol/sdk/server/mcp.js");
const stdio_js_1 = require("@modelcontextprotocol/sdk/server/stdio.js");
const zod_1 = require("zod");
const SearchEngineV2_1 = require("../search/SearchEngineV2");
...
class BrainMCPServerV2 {
    ...
    async initialize() {
        ...
        this.vectorStore = new VectorStoreV2_1.VectorStoreV2(this.configDir, this.fileRegistry);
        // Initialize search engine
        this.searchEngine = new SearchEngineV2_1.SearchEngineV2(this.vectorStore);
...
exports.BrainMCPServerV2 = BrainMCPServerV2;
// Start server
